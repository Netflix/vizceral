...
class ShapeUser {
  constructor () {
    ...
    this.customNode.material = this._createMaterial(GlobalStyles.shapesStyles.colorShapeUser);
  ...
  _createInnerGeometry (radius, curveSegments) {
    ...
    const newShapes = ShapesUtils.getShapeFromPolyPointsArray(polyPath, ' ', -19, -19);
