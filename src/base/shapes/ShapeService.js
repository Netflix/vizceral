...
class ShapeService {
  constructor () {
    ...
    this.customNode.material = this._createMaterial(GlobalStyles.styles.colorShapeService);
  ...
  _createOuterBorder (radius, curveSegments) {
    ...
    border.absarc(0, 0, radius, 0, Math.PI * 2, false);
    const borderHole = new THREE.Path();
    borderHole.absarc(0, 0, radius / 2, 0, Math.PI * 2, true);
