...
class NodeNameView extends BaseView {
  ...
  updateLabel () {
    ...
    // label color
    const labelColor = this.highlight ? GlobalStyles.styles.colorSeverityHighlighted[this.object.getSeverity()] : GlobalStyles.styles.colorSeverity[this.object.getSeverity()];
