...
class NodeNameView extends BaseView {
  ...
  updateLabel () {
    ...
    // label color
    const labelColor = this.highlight ? GlobalStyles.styles.colorTrafficHighlighted[this.object.getClass()] : GlobalStyles.styles.colorTraffic[this.object.getClass()];
