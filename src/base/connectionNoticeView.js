...
class ConnectionNoticeView extends BaseView {
  constructor (connectionView) {
    ...
    this.severity = 1;
    const noticeSize = this.connectionView.object.type === 'global' ? 105 : 48;
