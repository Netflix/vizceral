...
class NodeViewStandard extends NodeView {
  constructor (service) {
    ...
    const dotColor = GlobalStyles.threeStyles.colorSeverity[this.object.getSeverity()];
  ...
  refresh () {
    ...
    if (this.highlight) {
      ...
      this.dotMaterial.color.set(GlobalStyles.threeStyles.colorSeverity[severity]);
    }
